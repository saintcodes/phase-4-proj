...
puts "Seeding venues..."
venue1 = Venue.create(location: 'Hoffman')
venue2 = Venue.create(location: '40th Rd Park')
venue3 = Venue.create(location: 'Crowley')
venue4 = Venue.create(location: 'Juniper Valley')
venue5 = Venue.create(location: 'Grand St')
venue6 = Venue.create(location: 'McCarren Park')
venue7 = Venue.create(location: 'Flatiron Club')
...
Event.create(game_id: game4.id, venue_id: venue6.id, user_id: user4.id, date: "06/25/2022", time: "03:00PM")
Event.create(game_id: game4.id, venue_id: venue5.id, user_id: user14.id, date: "06/25/2022", time: "06:00PM")
Event.create(game_id: game4.id, venue_id: venue4.id, user_id: user2.id, date: "07/25/2022", time: "09:00AM")
Event.create(game_id: game5.id, venue_id: venue5.id, user_id: user7.id, date: "09/25/2022", time: "09:00AM")
Event.create(game_id: game6.id, venue_id: venue4.id, user_id: user10.id, date: "08/25/2022", time: "09:00AM")
Event.create(game_id: game7.id, venue_id: venue3.id, user_id: user3.id, date: "10/25/2022", time: "09:00AM")
Event.create(game_id: game8.id, venue_id: venue4.id, user_id: user12.id, date: "07/25/2022", time: "09:00AM")
Event.create(game_id: game9.id, venue_id: venue7.id, user_id: user12.id, date: "08/25/2022", time: "09:00AM")
