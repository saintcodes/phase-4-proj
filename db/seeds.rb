...
puts "Seeding users..."
user1 = User.create(username: "ozz")
user2 = User.create(username: "georgia")
user3 = User.create(username: "bobby")
user4 = User.create(username: "emt")
user5 = User.create(username: "nnlt")
user6 = User.create(username: "yxg")
user7 = User.create(username: "candies")
user8 = User.create(username: "wakkawakka")
user9 = User.create(username: "yml")
user10 = User.create(username: "schadek")
user11 = User.create(username: "dolma")
user12 = User.create(username: "imallin")
user13 = User.create(username: "densnowden")
user14 = User.create(username: "wild4stylez")
